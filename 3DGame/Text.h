...
//	double SCR_WIDTH, SCR_HEIGHT;
	...
	void init(string text, double screenX, double screenY, double SCR_WIDTH, double SCR_HEIGHT, double fontSizeX, double fontSizeY) {
...
public:
	Text(string text, string fontType, double screenX, double screenY, double fontSizeX, double fontSizeY, double SCR_WIDTH, double SCR_HEIGHT) {
	...
	Text(string text, SimpleModel* model, double screenX, double screenY, double fontSizeX, double fontSizeY, double SCR_WIDTH, double SCR_HEIGHT) {
		init(text, screenX, screenY, SCR_WIDTH, SCR_HEIGHT,fontSizeX, fontSizeY);
